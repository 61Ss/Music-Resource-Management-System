    ...
    <div>
        ...
        <div class="app-container">
            ...
            >
                ...
                <el-table-column align="center" header-align="center" label="Category Name">
                ...
                <el-table-column align="center" label="Actions">
                    <template #default="scope">
                        ...
                        <!--{{role_id}}-->
                        <el-button type="primary" size="small" @click="handleUpdate(scope)">Edit
                        </el-button>
...
function handleDelete(scope) {
    ElMessageBox.confirm("Are you sure to perform this action?", "Confirmation").then(() => {
        //删除
...
function handleUpdate(scope) {
    ...
    dialogFormId.value = parseInt(scope.row.projectinfo_typeid) 
